...
protected:
    ...
    // float Power_A = 0.875f;

    float Power_K_0 = 0.01030983f;
    float Power_K_1 = 0.00002594f;
    float Power_K_2 = 0.07677790f;
    float Power_A   = 0.52543750f;

    // const float Power_K_0 = 1.84895126e-02f;
    // const float Power_K_1 = 2.48118049e-05f;
    // const float Power_K_2 = 1.49239260e-01f;
    // const float Power_A   = 0.875f;
