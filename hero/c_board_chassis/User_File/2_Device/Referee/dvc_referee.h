...
// //     Referee_Command_ID_INTERACTION_CUSTOM_CONTROLLER_RECEIVE_ROBOT = 0x0309,
// //     Referee_Command_ID_INTERACTION_ROBOT_TO_CUSTOM_CLIENT = 0x0310,
// //     Referee_Command_ID_INTERACTION_CUSTOM_CLIENT_TO_ROBOT = 0x0311,
// // };
// //
// // /**
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x0202 当前机器人实时缓冲能量与射击热量
// //  *
// //  * 2026协议：
// //  * uint16_t reserved;
// //  * uint16_t reserved;
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x0204 当前机器人增益与剩余能量反馈
// //  *
// //  * 2026协议：
...
// //     uint8_t Remaining_Energy_Status;
// //     uint16_t CRC_16;
// // } __attribute__((packed));
// //
// //
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x0208 允许发弹量
// //  *
// //  * 2026协议：
// //  * 0-1  : 17mm允许发弹量
// //  * 2-3  : 42mm允许发弹量
// //  * 4-5  : 剩余金币
// //  * 6-7  : 堡垒增益点提供的储备17mm允许发弹量
// //  */
...
// //     uint16_t Money;
// //     uint16_t Fortress_Booster_17mm;
// //     uint16_t CRC_16;
// // } __attribute__((packed));
// //
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x0209 RFID状态信息
// //  *
// //  * 2026协议是 4 字节 + 1 字节
// //  */
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x020B 地面机器人位置数据
// //  *
// //  * 2026协议只有：英雄、工程、3号步兵、4号步兵，后面两个float是保留位
// //  */
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x020C 雷达标记进度数据
// //  *
// //  * 2026协议改成 2 字节 bit 位
// //  */
...
// //         struct
// //         {
// //             uint16_t Hero_1_Mark : 1;
// //             uint16_t Engineer_2_Mark : 1;
// //             uint16_t Infantry_3_Mark : 1;
// //             uint16_t Infantry_4_Mark : 1;
// //             uint16_t Aerial_6_Special_Status_Enum : 1;
// //             uint16_t Sentry_7_Mark : 1;
// //
// //             uint16_t Self_Hero_1_Special_Status_Enum : 1;
// //             uint16_t Self_Engineer_2_Special_Status_Enum : 1;
// //             uint16_t Self_Infantry_3_Special_Status_Enum : 1;
// //             uint16_t Self_Infantry_4_Special_Status_Enum : 1;
// //             uint16_t Self_Aerial_6_Special_Status_Enum : 1;
// //             uint16_t Self_Sentry_7_Special_Status_Enum : 1;
// //
// //             uint16_t Reserved : 4;
// //         };
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x020D 哨兵自主决策信息同步
// //  *
// //  * 2026协议：4字节 + 2字节
// //  */
...
// //             uint32_t Can_Respawn_Free_Enum : 1;
// //             uint32_t Can_Respawn_Immediately_Enum : 1;
// //             uint32_t Immediate_Respawn_Coin : 10;
...
// //         struct
// //         {
// //             uint16_t Out_Of_Combat_Status_Enum : 1;
// //             uint16_t Team_17mm_Exchangable_Ammo : 11;
// //             uint16_t Sentry_Posture_Enum : 2;
// //             uint16_t Power_Rune_Activatable_Enum : 1;
...
// //
// // /**
// //  * @brief 裁判系统经过处理的数据, 0x020E 雷达自主决策信息同步
// //  */
...
// //     uint8_t Friendly_Encryption_Level : 2;
// //     uint8_t Key_Modifiable_Enum : 1;
// //     uint8_t Reserved : 2;
// //     uint16_t CRC_16;
// // } __attribute__((packed));
// //
...
// // {
// //     return (Robot_Power_Heat.Booster_17mm_Heat);
// // }
// //
...
// // }
// //
// // inline uint16_t Class_Referee::Get_Booster_Heat_CD_Buff_Value()
// // {
...
// // {
// //     return (Robot_Buff.Defend_Debuff_Percent);
// // }
// //
// // inline uint16_t Class_Referee::Get_Damage_Buff_Percent()
// // {
// //     return (Robot_Buff.Damage_Buff_Percent);
// // }
// //
// // inline uint8_t Class_Referee::Get_Remaining_Energy_Status()
// // {
// //     return (Robot_Buff.Remaining_Energy_Status);
// // }
// //
...
// // }
// //
// // inline uint16_t Class_Referee::Get_Fortress_17mm_Remaining()
// // {
// //     return (Robot_Remaining_Ammo.Fortress_Booster_17mm);
// // }
// // /**
// //  * @brief 获取自身位置x
// //  *
...
// // {
// //     return (Robot_Radar_Mark.Sentry_7_Mark ? 100 : 0);
// // }
// //
// // /**
// //  * @brief 获取哨兵决策购买子弹数量
...
// } __attribute__((packed));
/**
 * @brief 裁判系统经过处理的数据, 0x0202 当前机器人实时缓冲能量和射击热量
 *
 * 2026协议：
 * data长度 = 14
 * byte0-1  : reserved
 * byte2-3  : reserved
 * byte4-7  : reserved
 * byte8-9  : buffer_energy
 * byte10-11: shooter_17mm_barrel_heat
 * byte12-13: shooter_42mm_barrel_heat
 */
struct Struct_Referee_Rx_Data_Robot_Power_Heat
{
    uint16_t Reserved_0;
...
public:
    ...
    inline uint16_t Get_Booster_17mm_Heat();
...
inline uint16_t Class_Referee::Get_Booster_17mm_Heat()
{
    return Robot_Power_Heat.Booster_17mm_Heat;
}
